...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/rvm/rubies/ruby-1.9.3-p547")
  ...
  CONFIG["configure_args"] = " '--prefix=/usr/local/rvm/rubies/ruby-1.9.3-p547' '--enable-load-relative' '--sysconfdir=/etc' '--disable-install-doc' '--enable-shared'"
